...
export function LastMinuteDealsCard({ title, slug, oldPrice, price, discount, countdown, image, location, rating, reviews }) {
  ...
  return (
    ...
    >
      <div className="relative z-0 h-40 xl:h-44 overflow-hidden">
        <img src={image} alt="" aria-hidden={true} className="h-full w-full object-cover transition duration-500 group-hover:scale-105" />
        ...
        <div className="mt-3 flex items-end justify-between gap-2">
          ...
          <div className="deal-timer-glow shrink-0">
            <div className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-orange-50 to-red-50 px-2 py-0.5 border border-orange-200/50">
              <svg className="size-2.5 text-orange-500 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
