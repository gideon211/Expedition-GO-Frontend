  ...
  return (
    <div className="flex min-h-screen flex-col bg-[color:var(--page-bg)] text-slate-900">
      ...
      <main className="mx-auto flex-1 w-full max-w-[1360px] px-5 py-5 sm:px-5 sm:py-7 lg:px-6 lg:py-8">
        ...
        {wishlist.length === 0 ? (
          <motion.div
            className="flex flex-col items-center justify-center py-10 text-center sm:py-14 lg:py-16"
          ...
          >
            ...
            <motion.div variants={textItem}>
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#39AD6C] px-5 py-2.5 text-sm font-semibold !text-white transition hover:bg-[#39AD6C]/90 hover:scale-[1.03] active:scale-[0.98] sm:px-6 sm:py-3 sm:text-base"
              >
